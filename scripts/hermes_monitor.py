...
TARGET = '/vol3/@appdata/hermes-studio-2'
APPCENTER = '/vol3/@appcenter/hermes-studio-2'
VAR = '/var/apps/hermes-studio-2'
...
if __name__ == '__main__':
    ...
    for i in range(600):
        ...
        ports = run("ss -tlnp 2>/dev/null | grep -E '8649|9119|18081' || echo 'no ports listening'")
        if ports != last_ports:
            log('PORTS CHANGED:')
            log(ports)
            last_ports = ports
